...
contract AtmAuctionTest is DutchAuctionTest {
  ...
  function test_constructor_success() public {
    ...
    assertEq(dutchAuction.bnbStrategy(), address(bnbStrategy), "bnbStrategy not assigned correctly");
  ...
  function test_fill_success_1() public override {
    ...
    assertEq(bnbStrategy.balanceOf(alice), defaultAmount, "bnbStrategy balance not assigned correctly");
  }
  ...
  function test_fill_success_2() public override {
    ...
    assertEq(bnbStrategy.balanceOf(alice), _amount, "bnbStrategy balance not assigned correctly");
  }
